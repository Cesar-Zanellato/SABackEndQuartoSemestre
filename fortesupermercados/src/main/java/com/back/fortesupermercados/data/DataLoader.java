...
public class DataLoader implements ApplicationRunner{
    ...
    public void run(ApplicationArguments args) {
        ...
        List<Product> products = List.of(
            new Product(null, "Açúcar União Refinado 1kg", "6.67", null, "Acucar_Uniao_Refinado_1kg.png", "Un", categoryMap.get("ALIMENTOSBASICOS"), subcategoryMap.get("ACUCAR"), null),
            ...
            new Product(null, "Farofa de Mandioca Tradicional Yoki 400g", "10.59", null, null, "Un", categoryMap.get("ALIMENTOSBASICOS"), subcategoryMap.get("FAROFA"), null),
            ...
            new Product(null, "Farofa Kanty Calabresa 250g", "5.51", null, null, "Un", categoryMap.get("ALIMENTOSBASICOS"), subcategoryMap.get("FAROFA"), null),
            new Product(null, "Farofa Kanty Picanha 250g", "5.51", null, null, "Un", categoryMap.get("ALIMENTOSBASICOS"), subcategoryMap.get("FAROFA"), null),
            ...
            new Product(null, "Feijão Branco Sinhá 500g", "13.70", null, null, "Un", categoryMap.get("ALIMENTOSBASICOS"), subcategoryMap.get("FEIJAO"), null),
